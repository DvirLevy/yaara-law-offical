...
export default function Hero() {
  ...
  return (
    <div className="relative z-[2] flex h-screen min-h-[680px] items-center overflow-hidden max-lg:h-auto max-lg:min-h-[100svh] max-lg:flex-col max-lg:items-stretch" id="top">
      <div className="absolute inset-y-0 end-0 z-[1] flex w-[54%] items-end justify-center overflow-visible before:absolute before:inset-0 before:z-0 before:[background:radial-gradient(58%_60%_at_46%_64%,theme(colors.brand.soft),transparent_72%)] max-lg:static max-lg:h-[62vw] max-lg:min-h-[320px] max-lg:max-h-[460px] max-lg:w-full max-lg:after:absolute max-lg:after:inset-x-0 max-lg:after:bottom-0 max-lg:after:z-[2] max-lg:after:h-20 max-lg:after:bg-gradient-to-t max-lg:after:from-background max-lg:after:to-transparent max-lg:after:content-['']">
        <LazyImage
          ...
          alt="Adv. Yaara Levy"
          className="relative z-[1] h-[96%] w-auto max-w-full object-contain object-bottom drop-shadow-[0_24px_38px_rgba(20,16,14,.22)] max-lg:h-full"
        />
      </div>
      <div className="relative z-[2] flex w-full justify-start">
        <div className="relative flex w-[46%] flex-col justify-center py-[120px] ps-5 pe-[72px] before:absolute before:top-[14%] before:bottom-[14%] before:end-0 before:w-px before:[background:linear-gradient(to_bottom,transparent,theme(colors.brand.line),transparent)] max-lg:static max-lg:w-full max-lg:px-6 max-lg:pt-8 max-lg:pb-14 max-lg:before:hidden">
